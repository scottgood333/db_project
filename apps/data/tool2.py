...
cmd = """                      <div class="form-check form-check-inline">
...
day_c = ['一', '二', '三', '四', '五', '六', '日']
day_e = ['mon', 'tue', 'wed', 'thr', 'fri', 'sat', 'sun']

day_dict = {k:v for k, v in zip(day_c, day_e)}

# print(cmd.format("jdspa","jdpafs","['jdfopa']","jdpopas"))

for key, value in day_dict.items():
    print(key, ":", value)
    file.write(cmd.format(value, value, key))
